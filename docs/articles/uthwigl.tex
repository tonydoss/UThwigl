...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{output_cs}\OperatorTok{$}\NormalTok{plots}
\end{Highlighting}
\end{Shaded}

\begin{figure}
\includegraphics[width=0.95\linewidth]{C:\Users\tonyd\ONEDRI~1\R\U-THWI~1\docs\articles\UTHWIG~1/figure-latex/csuthvizfig-1} \caption{(ref:csuthvizfigcap)}(\#fig:csuthvizfig)
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{output_os}\OperatorTok{$}\NormalTok{plots}
\end{Highlighting}
\end{Shaded}

\begin{figure}
\includegraphics[width=0.95\linewidth]{C:\Users\tonyd\ONEDRI~1\R\U-THWI~1\docs\articles\UTHWIG~1/figure-latex/demopanelfig-1} \caption{(ref:demopanelfigcap)}(\#fig:demopanelfig)
\end{figure}
