...
heme_plots <-
  theme(
    plot.title = element_text(size = (1big_size, hjust = 0.5),
    legend.title = element_blank(),
    axis.title.y = element_text(size = 1big_size),
    axis.title.x = element_text(size = big_size,
    axis.text.x = element_text(size = 1less_big_size,
    axis.text.y = element_text(size = 1less_big_size
  ) +
  theme_bw() +
...
# combine plots
library(patchwork) 
(T_sol_plot + th230u238_plot)  / (U_ppm_plot + u234_u238_plot)
```
