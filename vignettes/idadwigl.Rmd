...
(i) a histogram of the solution ages (Figure \@ref(fig:tsol)), 
<!-- not sure that's really useful, it's not really a Gaussian distribution. -->
(ii) the U concentrations in the sample as a function of the relative distance from the center (Figure \@ref(fig:Uconc))  
(iii) the measured (in blue) and modelled (in red) (^234^U/^238^U) activity ratios as a function of the relative distance from the center (Figure \@ref(fig:U48)), and
(iv) the measured (in blue) and modelled (in red) (^230^Th/^238^U) activity ratios as a function of the relative distance from the center (Figure \@ref(fig:Th0U8)).
...
```{r tsol, echo=FALSE, fig.cap="Histograme of the solution ages for a given run"}
...
```{r Uconc, fig.cap="Uranium concentration profile for transect 2 of modern human femur 132A/LB/27D/03", echo = FALSE}
ggplot(df) + 
...
```{r U48, echo=FALSE, fig.cap="Calculated (red) and observed (blue) (^234^U/^238^U) activity ratios for transect 2 of modern human femur 132A/LB/27D/03" }
ggplot(df) + 
...
```{r Th0U8, echo=FALSE, fig.cap="Calculated (red) and observed (blue) (^230^Th/^238^U) activity ratios for transect 2 of modern human femur 132A/LB/27D/03" }
