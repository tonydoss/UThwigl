...
The `x` and `y` columns corresponds to the coordinates of the inner, outer surfaces and the analyses (Figure \@ref(fig:femurpic)). 

Columns `U234_U238`, `U234_U238_2SE`, `Th230_U238`, `Th230_U238_2SE`are the 
