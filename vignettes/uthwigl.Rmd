...
Our package provides the fuction `csUTh()` for closed-system U-Th dating. 
...
For open-system U-Th dating we provide the function `osUTh()` requires a data frame (a form of table in R) with the following column names:
