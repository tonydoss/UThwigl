...
First, in RStudio'Files panel, the user should navigate to the working directorty of choice and select 'More > Set As Working Directory'. Alternatively, the working directory can be defined in the Console panel as in the example below:
