...
The package includes sample data from Marine Isotope Stage 5 corals from @RN5108. Two *Plesiastrea versipora* coral samples were analysed: YP002 and YP003. The first two rows are bulk analyses while the rest are in-situ analyses produced by laser ablation (hence the lower precision compared to the first two rows).
